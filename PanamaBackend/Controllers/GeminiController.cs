...
namespace PanamaBackend.Controllers
{
    ...
    public class GeminiController : ControllerBase
    {
        ...
        public async Task<IActionResult> GenerateResponse([FromBody] PromptRequest request)
        {
            ...
            var combinedPrompt = 
                "You are an expert on the Panama Virus. You have been provided with a database of outbreak locations and exist to analyze the data and provide insight into any questions asked. Do not bold text or use markdown formatting.\n\n" +
